...
public class Uniprot2PathwayImport {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileName = "/Users/ninni/biodb/reactome/uniprot2pathway.txt";
		String line;
        ...
        while ((line = reader.readLine()) != null) {        	
        	...
        	Iterator<Vertex> it = graph.getVertices("proteinAccession.name", uniprotId).iterator();
			if (it.hasNext())
			...
			it = graph.getVertices("pathway.id", pathwayId).iterator();
			if (it.hasNext())
				pathway = it.next();
